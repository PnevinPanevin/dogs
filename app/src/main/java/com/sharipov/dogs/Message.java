...
public class Message {
    ...
    @Expose
    private Map<String, List<String>> bulldog = null;
    ...
    @SerializedName("coton")
    @Expose
    private List<String> coton = null;
    ...
    public Map<String, List<String>> getBulldog() {
        return bulldog;
    }

    public void setBulldog(Map<String, List<String>> bulldog) {
    ...
    public List<String> getCoton() {
        return coton;
    }

    public void setCoton(List<String> coton) {
        this.coton = coton;
    }
